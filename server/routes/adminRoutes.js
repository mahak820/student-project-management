...
const { getAllUser, addUser, getUser, getProject, getProjects, addProjectTopic, deleteProjectTopic, updateProjectTopic, addReview, addRank, deleteUser, getAllUserProfile, getAllProjectTopic, getUserAllProjects, getAllReviews } = require("../controllers/adminControllers")
...
router.get("/projects/:uid",adminProtect  ,getUserAllProjects)
...
router.get("/review",adminProtect  ,getAllReviews)
router.post("/rank/:_ptid",adminProtect  ,addRank)
